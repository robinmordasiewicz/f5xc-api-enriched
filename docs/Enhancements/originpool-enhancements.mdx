...
Enrichment metadata for origin_pool-related schemas. See [OpenAPI Extensions](../development/#openapi-extensions) for extension definitions.
...
- [Healthcheck Enhancements](./healthcheck-enhancements/) - Healthcheck schema enrichments
