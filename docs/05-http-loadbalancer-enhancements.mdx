...
Enrichment metadata for HTTP load balancer schemas. See [OpenAPI Extensions](../01-development/#openapi-extensions) for extension definitions.
...
- [Healthcheck Enhancements](../04-healthcheck-enhancements/) - Healthcheck schema enrichments (includes `x-f5xc-recommended-oneof-variant`)
- [Origin Pool Enhancements](../06-originpool-enhancements/) - Origin pool schema enrichments
- [Constraint Metadata Guide](../02-constraint-metadata/) - Detailed constraint validation documentation
